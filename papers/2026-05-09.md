...
### 1. **[NavOne: One-Step Global Planning for Vision-Language Navigation on Top-Down Maps](https://arxiv.org/abs/2605.06317v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: Dijia Zhan, Jinyi Li, Chenxi Zheng et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出NavOne实现顶视图下的端到端全局路径规划。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过重构导航范式显著提升效率，实验充分且方法创新。

### 2. **[GeoStack: A Framework for Quasi-Abelian Knowledge Composition in VLMs](https://arxiv.org/abs/2605.06477v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-07
- **作者**: Pranav Mantini, Shishir K. Shah
- **标签**: `cs.CV`
- **AI摘要**: 提出GeoStack框架实现VLM知识高效组合
<details>
<summary>原始摘要</summary>
...
### 1. **[FREPix: Frequency-Heterogeneous Flow Matching for Pixel-Space Image Generation](https://arxiv.org/abs/2605.06421v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-07
- **作者**: Mingfeng Lin, Jiakun Chen, Liang Han et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出频域异构流匹配框架以优化像素级图像生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过频域分解提升了生成效率与质量，方法创新且实验扎实。

## Video Generation

### 1. **[FreeSpec: Training-Free Long Video Generation via Singular-Spectrum Reconstruction](https://arxiv.org/abs/2605.06509v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: Fangda Chen, Shanshan Zhao, Longrong Yang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出FreeSpec实现长视频生成，解决内容漂移与细节丢失。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过奇异谱分析优化长视频生成，方法创新且实验扎实。

### 2. **[SwiftI2V: Efficient High-Resolution Image-to-Video Generation via Conditional Segment-wise Generation](https://arxiv.org/abs/2605.06356v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: YaoYang Liu, Yuechen Zhang, Wenbo Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出SwiftI2V实现高效高分辨率图像转视频生成
<details>
<summary>原始摘要</summary>
...
- **评分**: ⭐ 78/100 | **日期**: 2026-05-07
- **作者**: Ziyun Zeng, Yiqi Lin, Guoqiang Liang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出Sparkle数据集与模型，解决视频背景替换难题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦引导策略提升了背景替换质量，实验充分且开源。

### 4. **[ActCam: Zero-Shot Joint Camera and 3D Motion Control for Video Generation](https://arxiv.org/abs/2605.06667v1)**
- **评分**: ⭐ 72/100 | **日期**: 2026-05-07
- **作者**: Omar El Khalifi, Thomas Rossi, Oscar Fossey et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出一种无需训练即可实现角色动作与相机轨迹协同控制的方法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 采用两阶段引导策略实现零样本联合控制，在相机一致性和动作保真度上表现良好。
...
### 1. **[FedAttr: Towards Privacy-preserving Client-Level Attribution in Federated LLM Fine-tuning](https://arxiv.org/abs/2605.06596v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: Su Zhang, Junfeng Guo, Heng Huang
- **标签**: `cs.CR` `cs.LG`
- **AI摘要**: 联邦学习中隐私保护的客户端归因协议
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出创新归因机制，理论严谨且实验效果显著。

### 2. **[CCL-Bench 1.0: A Trace-Based Benchmark for LLM Infrastructure](https://arxiv.org/abs/2605.06544v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: Eric Ding, Byungsoo Oh, Bhaskar Kataria et al.
- **标签**: `cs.DC` `cs.NI`
- **AI摘要**: 提出基于追踪的LLM基础设施基准测试工具CCL-Bench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，有效揭示了基础设施性能瓶颈。

### 3. **[ROSE: Rollout On Serving GPUs via Cooperative Elasticity for Agentic RL](https://arxiv.org/abs/2605.06534v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: Wei Gao, Yuheng Zhao, Dilxat Muhtar et al.
- **标签**: `cs.DC`
- **AI摘要**: 利用服务GPU空闲算力加速智能体RL训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出创新的协同弹性机制，显著提升了RL训练效率与资源利用率。

### 4. **[Federated Cross-Client Subgraph Pattern Detection](https://arxiv.org/abs/2605.06433v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-07
- **作者**: Selin Ceydeli, Rui Wang, Kubilay Atasu
- **标签**: `cs.LG`
- **AI摘要**: 提出联邦子图模式检测框架以消除分布式表示差距。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且解决了分布式图神经网络的结构可观测性问题。

### 5. **[ResiHP: Taming LLM Training Failures with Dynamic Hybrid](https://arxiv.org/abs/2605.06374v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-07
- **作者**: Tenghui Ma, Jihu Guo, Wei Gao et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出ResiHP系统以优化大规模LLM训练的容错与调度效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对大规模训练故障处理的创新方案，实验验证充分，实用性强。

## Information Retrieval

### 1. **[PianoCoRe: Combined and Refined Piano MIDI Dataset](https://arxiv.org/abs/2605.06627v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: Ilya Borovik
- **标签**: `cs.SD` `cs.LG`
- **AI摘要**: 发布大规模钢琴MIDI数据集PianoCoRe
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集规模大且质量高，对MIR领域贡献显著。

### 2. **[GATHER: Convergence-Centric Hyper-Entity Retrieval for Zero-Shot Cell-Type Annotation](https://arxiv.org/abs/2605.06403v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: Zhonghui Zhang, Feng Jiang, Shaowei Qin et al.
- **标签**: `cs.CL` `cs.IR`
- **AI摘要**: 提出GATHER方法实现高效零样本细胞类型标注。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过拓扑收敛点优化图检索，显著提升效率与准确性。

### 3. **[Expressiveness Limits of Autoregressive Semantic ID Generation in Generative Recommendation](https://arxiv.org/abs/2605.06331v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-07
- **作者**: Yupeng Hou, Haven Kim, Clark Mingxuan Ju et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出Latte架构解决生成式推荐中语义ID树结构的表达限制。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析深入，通过引入潜变量缓解概率耦合，实验提升显著。

### 4. **[Light-FMP: Lightweight Feature and Model Pruning for Enhanced Deep Recommender Systems](https://arxiv.org/abs/2605.06441v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-07
- **作者**: Nghia Bui, Yue Ning, Lijing Wang
- **标签**: `cs.IR`
- **AI摘要**: 提出轻量化特征与模型剪枝框架提升推荐系统效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过三阶段剪枝平衡了推荐系统的精度与计算效率

### 5. **[Superintelligent Retrieval Agent: The Next Frontier of Information Retrieval](https://arxiv.org/abs/2605.06647v1)**
- **评分**: ⭐ 72/100 | **日期**: 2026-05-07
- **作者**: Zeyu Yang, Qi Ma, Jason Chen et al.
- **标签**: `cs.IR` `cs.AI` `cs.LG`
- **AI摘要**: SIRA通过LLM与语料统计将多轮检索压缩为单次高效检索。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地结合语料统计优化查询扩展，在效率与性能间取得良好平衡。
...
### 1. **[When and Why SignSGD Outperforms SGD: A Theoretical Study Based on $\ell_1$-norm Lower Bounds](https://arxiv.org/abs/2605.06615v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-07
- **作者**: Hongyi Tao, Dingzhi Yu, Lijun Zhang
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 揭示SignSGD优于SGD的理论机制与维度优势
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具开创性，有效解释了符号优化器的性能优势。

### 2. **[Weight-Decay Turns Transformer Loss Landscapes Villani: Functional-Analytic Foundations for Optimization and Generalization](https://arxiv.org/abs/2605.06599v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-07
- **作者**: Abhijit Das, Sayantan Dutta
- **标签**: `cs.LG` `eess.AS`
- **AI摘要**: 揭示权重衰减对Transformer损失函数的数学影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过泛函分析严谨证明了权重衰减的收敛与泛化机制

### 3. **[Dynamic Treatment on Networks](https://arxiv.org/abs/2605.06564v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-07
- **作者**: Bengusu Nar, Jiguang Li, Veronika Ročková et al.
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出Q-Ising框架优化网络动态干预策略
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合贝叶斯Ising模型与离线强化学习，理论严谨且应用价值高。

### 4. **[E = T*H/(O+B): A Dimensionless Control Parameter for Mixture-of-Experts Ecology](https://arxiv.org/abs/2605.06415v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-07
- **作者**: Qingjun Zhang
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出无量纲参数E预测MoE专家健康度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过无量纲参数简化MoE调优，实验严谨且具有普适性。

### 5. **[WavCube: Unifying Speech Representation for Understanding and Generation via Semantic-Acoustic Joint Modeling](https://arxiv.org/abs/2605.06407v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-07
- **作者**: Guanrou Yang, Tian Tan, Qian Chen et al.
- **标签**: `eess.AS` `cs.AI` `cs.CL`
- **AI摘要**: 提出WavCube统一语音理解与生成表示
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过两阶段训练实现语义与声学特征融合，性能优异且通用性强。
