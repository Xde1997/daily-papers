...
### 1. **[Grounded or Guessing? LVLM Confidence Estimation via Blind-Image Contrastive Ranking](https://arxiv.org/abs/2605.10893v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Reza Khanmohammadi, Erfan Miahi, Simerjot Kaur et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出盲图对比排序 BICR，提升 LVLM 置信度校准与视觉接地。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新利用盲图对比训练轻量探针，在多任务多模型上显著提升校准与判别性能。

### 2. **[Verification Mirage: Mapping the Reliability Boundary of Self-Verification in Medical VQA](https://arxiv.org/abs/2605.10850v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Ruinan Jin, Beidi Zhao, Myeongkyun Kang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出诊断框架揭示医学VQA自验证的可靠边界与验证幻影。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 框架创新、实验充分，但对自验证局限性的实用建议有限。

### 3. **[Count Anything at Any Granularity](https://arxiv.org/abs/2605.10887v1)**
- **评分**: ⭐ 73/100 | **日期**: 2026-05-11
- **作者**: Chang Liu, Haoning Wu, Weidi Xie
- **标签**: `cs.CV`
- **AI摘要**: 提出多粒度计数框架与KubriCount数据集提升计数精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过细粒度提示和自动数据生成pipeline验证模型在多粒度计数上显著提升

### 4. **[GridProbe: Posterior-Probing for Adaptive Test-Time Compute in Long-Video VLMs](https://arxiv.org/abs/2605.10762v1)**
- **评分**: ⭐ 73/100 | **日期**: 2026-05-11
- **作者**: Mohamed Eltahir, Lama Ayash, Ali Habibullah et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 网格探测实现长视频VLM自适应帧选择，显著降计算。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新后验探测框架，显著降低算力同时保持精度，实验验证充分。

### 5. **[CapVector: Learning Transferable Capability Vectors in Parametric Space for Vision-Language-Action Models](https://arxiv.org/abs/2605.10903v1)**
- **评分**: ⭐ 72/100 | **日期**: 2026-05-11
- **作者**: Wenxuan Song, Han Zhao, Fuhao Li et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 通过参数空间分离能力向量，实现高效零成本能力增强的VLA微调
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用参数差分构建可迁移能力向量，合并后仅需轻量正交正则即可达到辅助训练效果，计算开销显著降低。
...
### 1. **[Masked Generative Transformer Is What You Need for Image Editing](https://arxiv.org/abs/2605.10859v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-11
- **作者**: Wei Chow, Linfeng Li, Xian Sun et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 掩码生成Transformer实现局部化图像编辑，6倍加速
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用MGT局部预测机制和区域保持采样，实现精准编辑且速度提升显著。

### 2. **[Beyond the Last Layer: Multi-Layer Representation Fusion for Visual Tokenizatio](https://arxiv.org/abs/2605.10780v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-05-11
- **作者**: Xuanyu Zhu, Yan Bai, Yang Shi et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出DRoRAE多层特征融合，显著提升视觉tokenizer质量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖且实验充分，提升重建与生成质量，Scaling Law验证实用性

## Video Generation

### 1. **[Is Your Driving World Model an All-Around Player?](https://arxiv.org/abs/2605.10858v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-11
- **作者**: Lingdong Kong, Ao Liang, Tianyi Yan et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 提出WorldLens基准评估驾驶世界模型的多维度性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新点在多维度评估体系，实用性强，实验充分，表述清晰。

### 2. **[PhyGround: Benchmarking Physical Reasoning in Generative World Models](https://arxiv.org/abs/2605.10806v1)**
- **评分**: ⭐ 73/100 | **日期**: 2026-05-11
- **作者**: Juyi Lin, Arash Akbari, Yumei He et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 构建PhyGround基准，评估视频生成模型的物理推理。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新提出细粒度物理法则诊断基准，大规模人工标注验证，发布专用评判模型，显著提升评估可靠性。
...
### 1. **[On the global convergence of gradient descent for wide shallow models with bounded nonlinearities](https://arxiv.org/abs/2605.10775v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Romain Petit, Clarice Poon, Gabriel Peyré
- **标签**: `math.OC` `cs.LG`
- **AI摘要**: 证明宽浅网络中梯度下降在无限宽度极限下仅收敛至全局最小值
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论扩展、证明严格、对理解深度学习训练机制具重要意义

### 2. **[Neural Weight Norm = Kolmogorov Complexity](https://arxiv.org/abs/2605.10878v1)**
- **评分**: ⭐ 77/100 | **日期**: 2026-05-11
- **作者**: Tiberiu Musat
- **标签**: `cs.LG` `cs.IT`
- **AI摘要**: 证明了权重范数在固定精度下等价于字符串的科尔莫戈罗夫复杂度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合权重衰减与Solomonoff先验，提供严密的理论等价性证明，解释其机制

### 3. **[Attractor-Vascular Coupling Theory: Formal Grounding and Empirical Validation for AAMI-Standard Cuffless Blood Pressure Estimation from Smartphone Photoplethysmography](https://arxiv.org/abs/2605.10871v1)**
- **评分**: ⭐ 77/100 | **日期**: 2026-05-11
- **作者**: Timothy Oladunni, Farouk Ganiyu Adewumi
- **标签**: `physics.med-ph` `cs.AI` `cs.LG`
- **AI摘要**: 提出吸引子-血管耦合理论实现手机PPG无袖带血压AAMI标准估计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论有创新且验证充分，结果满足AAMI标准，应用价值高

### 4. **[Benchmarking Sensor-Fault Robustness in Forecasting](https://arxiv.org/abs/2605.10822v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-11
- **作者**: Alexander Windmann, Philipp Wittenberg, Gianluca Manca et al.
- **标签**: `cs.LG` `eess.SP`
- **AI摘要**: 提出传感器故障基准评估预报模型鲁棒性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基准框架新颖、实用性强、实验充分，扣分因缺乏突破性创新。

### 5. **[Clin-JEPA: A Multi-Phase Co-Training Framework for Joint-Embedding Predictive Pretraining on EHR Patient Trajectories](https://arxiv.org/abs/2605.10840v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-05-11
- **作者**: Yixuan Yang, Mehak Arora, Ryan Zhang et al.
- **标签**: `cs.LG` `cs.AI` `q-bio.QM`
- **AI摘要**: 提出多阶段协同训练JEPA框架，提升EHR预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新五阶段课程提升协同训练稳定性，实验验证提升显著
