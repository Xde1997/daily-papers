...
### 1. **[Quantifying the human visual exposome with vision language models](https://arxiv.org/abs/2605.03863v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-05
- **作者**: Christian Rominger, Andreas R. Schwerdtfeger, Malay Gaherwar Singh et al.
- **标签**: `cs.AI` `cs.CV`
- **AI摘要**: 利用VLM量化视觉暴露组与心理健康的关系
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地结合VLM与生态瞬时评估，方法严谨且应用价值高。

### 2. **[What You Think is What You See: Driving Exploration in VLM Agents via Visual-Linguistic Curiosity](https://arxiv.org/abs/2605.03782v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-05
- **作者**: Haoxi Li, Qinglin Hou, Jianfei Ma et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出GLANCE框架，通过视觉语言好奇心驱动智能体探索。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入好奇心机制，实验充分，逻辑清晰。

### 3. **[StateVLM: A State-Aware Vision-Language Model for Robotic Affordance Reasoning](https://arxiv.org/abs/2605.03927v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-05
- **作者**: Xiaowen Sun, Matthias Kerzel, Mengdi Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出StateVLM提升机器人状态感知与定位能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入辅助回归损失优化定位，并构建了OSAR基准，实验扎实。

### 4. **[Before Forgetting, Learn to Remember: Revisiting Foundational Learning Failures in LVLM Unlearning Benchmarks](https://arxiv.org/abs/2605.03759v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-05
- **作者**: JuneHyoung Kwon, MiHyeon Kim, Eunju Lee et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出ReMem基准以解决LVLM遗忘评估中的记忆失效问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对模型遗忘评估中的基础记忆失效问题，提出了有效的评估框架与度量指标。

### 5. **[Erase Persona, Forget Lore: Benchmarking Multimodal Copyright Unlearning in Large Vision Language Models](https://arxiv.org/abs/2605.03547v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-05
- **作者**: JuneHyoung Kwon, JungMin Yun, YoungBin Kim
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出首个多模态版权遗忘基准CoVUBench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了多模态模型版权遗忘评估的空白，方法严谨且具实用性。
...
### 1. **[AniMatrix: An Anime Video Generation Model that Thinks in Art, Not Physics](https://arxiv.org/abs/2605.03652v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-05
- **作者**: Tencent HY Team
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出AniMatrix模型，实现非物理规律的动画视频生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过生产知识系统与形变优化，有效解决了动画艺术表达难题。

### 2. **[WorldJen: An End-to-End Multi-Dimensional Benchmark for Generative Video Models](https://arxiv.org/abs/2605.03475v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-05
- **作者**: Karthik Inbasekar, Guy Rom, Omer Shlomovits
- **标签**: `cs.CV`
- **AI摘要**: 提出多维视频生成评估基准WorldJen
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过VLM评估与人类偏好对齐，方法严谨且实用。

### 3. **[Stream-R1: Reliability-Perplexity Aware Reward Distillation for Streaming Video Generation](https://arxiv.org/abs/2605.03849v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-05
- **作者**: Bin Wu, Mengqi Huang, Shaojin Wu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出流式视频生成奖励蒸馏框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过可靠性与困惑度感知优化蒸馏，显著提升生成质量。

### 4. **[RoboAlign-R1: Distilled Multimodal Reward Alignment for Robot Video World Models](https://arxiv.org/abs/2605.03821v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-05
- **作者**: Hao Wu, Yuqi Li, Yuan Gao et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出机器人视频世界模型对齐框架
<details>
<summary>原始摘要</summary>
...
### 1. **[Enhancing Performance Insight at Scale: A Heterogeneous Framework for Exascale Diagnostics](https://arxiv.org/abs/2605.03561v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-05
- **作者**: Dragana Grbic
- **标签**: `cs.DC` `cs.PF`
- **AI摘要**: 提出高性能异构诊断框架以优化超算性能分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在超大规模系统诊断上实现显著加速，实验严谨且实用性强。

### 2. **[Surviving the Edge: Federated Learning under Networking and Resource Constraints](https://arxiv.org/abs/2605.03870v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-05
- **作者**: Mike Mwanje, Okemawo Obadofin, Theophilus Benson et al.
- **标签**: `cs.NI` `cs.DC`
- **AI摘要**: 揭示边缘FL在极端网络下的TCP瓶颈
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性量化了FL在边缘网络下的性能边界，实用性强。

### 3. **[Implementing True MPI Sessions and Evaluating MPI Initialization Scalability](https://arxiv.org/abs/2605.03983v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-05
- **作者**: Hui Zhou, Kenneth Raffenetti, Yanfei Guo et al.
- **标签**: `cs.DC`
- **AI摘要**: 实现MPICH真MPI会话以提升扩展性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过重构MPICH实现真会话，有效提升了大规模系统扩展性。

### 4. **[A Hierarchical Sampling Framework for bounding the Generalization Error of Federated Learning](https://arxiv.org/abs/2605.03499v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-05
- **作者**: Dario Filatrella, Ragnar Thobaben, Mikael Skoglund
- **标签**: `cs.LG` `cs.IT` `stat.ML`
- **AI摘要**: 提出分层联邦学习泛化误差界框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且泛化性强，对联邦学习理论有贡献

### 5. **[A Workflow-Oriented Framework for Asynchronous Human-AI Collaboration in Hybrid and Compute-Intensive HPC Environments](https://arxiv.org/abs/2605.03743v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-05
- **作者**: Sergio Mendoza, Cedric Bhihe, Natalia Zamora et al.
- **标签**: `cs.DC` `cs.AI` `cs.HC`
- **AI摘要**: 提出支持HPC环境异步人机协作的工作流框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 有效解决了HPC计算资源与人机交互的异步调度难题

## Information Retrieval

### 1. **[PHALAR: Phasors for Learned Musical Audio Representations](https://arxiv.org/abs/2605.03929v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-05
- **作者**: Davide Marincione, Michele Mancusi, Giorgio Strano et al.
- **标签**: `cs.SD` `cs.AI` `cs.LG`
- **AI摘要**: 提出PHALAR模型，提升音频分轨检索效率与精度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型架构创新显著，实验验证充分，检索性能提升大。

### 2. **[Aspect-Aware Content-Based Recommendations for Mathematical Research Papers](https://arxiv.org/abs/2605.03861v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-05
- **作者**: Ankit Satpute, André Greiner-Petter, Noah Gießing et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出AchGNN模型实现数学论文的方面感知推荐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对数学领域特性创新性引入方面感知GNN，实验严谨且具有实际应用价值。

### 3. **[SURE-RAG: Sufficiency and Uncertainty-Aware Evidence Verification for Selective Retrieval-Augmented Generation](https://arxiv.org/abs/2605.03534v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-05
- **作者**: Jingxi Qiu, Zeyu Han, Cheng Huang
- **标签**: `cs.CL` `cs.IR` `cs.LG`
- **AI摘要**: 提出SURE-RAG框架，通过证据充分性验证提升RAG回答可靠性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，有效解决了RAG证据验证难题。

### 4. **[Reproducing Complex Set-Compositional Information Retrieval](https://arxiv.org/abs/2605.03824v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-05
- **作者**: Vincent Degenhart, Dewi Timman, Arjen P. de Vries et al.
- **标签**: `cs.CL`
- **AI摘要**: 揭示神经检索在复杂组合查询中的局限性并提出新基准。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究严谨，通过LIMIT+基准揭示了现有模型在逻辑约束下的性能瓶颈。

### 5. **[Rethinking Reasoning-Intensive Retrieval: Evaluating and Advancing Retrievers in Agentic Search Systems](https://arxiv.org/abs/2605.04018v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-05
- **作者**: Yilun Zhao, Jinbiao Wei, Tingyu Song et al.
- **标签**: `cs.CL` `cs.IR`
- **AI摘要**: 提出BRIGHT-Pro基准与RTriever模型，优化智能体推理检索。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对智能体搜索中的多维度证据需求，构建了高质量基准与合成语料，实验严谨。
...
### 1. **[Training-Free Probabilistic Time-Series Forecasting with Conformal Seasonal Pools](https://arxiv.org/abs/2605.03789v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-05
- **作者**: Valery Manokhin
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出无需训练的CSP时间序列预测方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且性能显著优于现有深度学习基准

### 2. **[Stochastic Schrödinger Diffusion Models for Pure-State Ensemble Generation](https://arxiv.org/abs/2605.03573v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-05
- **作者**: Jian Xu, Wei Chen. Chao Li, Jingyuan Zheng et al.
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出基于黎曼流形的量子纯态扩散模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 将扩散模型推广至量子纯态空间，理论创新且实验扎实。

### 3. **[Random test functions, $H^{-1}$ norm equivalence, and stochastic variational physics-informed neural networks](https://arxiv.org/abs/2605.03542v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-05
- **作者**: Diego Marcondes
- **标签**: `math.NA` `cs.LG`
- **AI摘要**: 提出随机测试函数法以优化PINNs求解偏微分方程。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，通过随机范数等价性显著提升了物理信息神经网络的求解精度与效率。

### 4. **[The Manokhin Probability Matrix: A Diagnostic Framework for Classifier Probability Quality](https://arxiv.org/abs/2605.03816v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-05
- **作者**: Valery Manokhin
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出Manokhin矩阵以解耦分类器校准与判别能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过矩阵框架有效分解Brier分数，实验设计严谨且实用。

### 5. **[Pretrained Model Representations as Acquisition Signals for Active Learning of MLIPs](https://arxiv.org/abs/2605.03964v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-05
- **作者**: Eszter Varga-Umbrich, Shikha Surana, Paul Duckworth et al.
- **标签**: `cs.LG` `physics.chem-ph`
- **AI摘要**: 利用预训练模型特征提升主动学习效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出新颖的获取函数，显著提升MLIP训练效率，实验严谨。
